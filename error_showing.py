    ...
    for boleto in boletos:
        ...
        with pdfplumber.open(boleto) as pdf:
            ...
            if "CONSUMO SCEE" in text:
                consumo_compensado = text.split("CONSUMO SCEE")[-1].strip().split(" ")[1]
            ...
            if "INJEÇÃO SCEE" in text:
                geracao_abatida = text.split("INJEÇÃO SCEE")[-1].upper().split("KWH")[1].strip().split(" ")[0].replace(",", ".")
            ...
            if "INJEÇÃO SCEE" in text:
                injecao_scee = text.split("INJEÇÃO SCEE")[-1].strip().split("\n")[0].upper().split("KWH")[-1].strip().split(" ")[2].replace("-", "").replace(".", "").replace(",", ".")
            ...
            if "BANDEIRA" in text:
                ...
                bandeira_tarifaria = float(re.findall(regex, text.split("BANDEIRA")[-1].strip().split("\n")[0])[2].replace(",", "."))
